    ...
    previous_yreal = 0;
      ...
      if general.inverse == 1 then
        if general.realtime_new_only ~= 1 
          ...
          ylabel('температура, °C');
          for i=1:1:size(results.Yreal, 'r')
            plot(tau, results.Yreal(i, :) + previous_yreal, 'b');
          end
          ...
          U1_ext = getURT(rule, general.dt, general.sp_length * general.sp_total, previous_time);
          Q_RMS = sqrt(norm(U1_ext - general.U(:,1))^2/size(U1_ext, 'r'));
          xtitle("СКО = " + string(Q_RMS));
          xgrid(1);
          xlabel('время, с');
...
general = tlist(['problem';'direct';'dynresp';'dynresp_additional';'dynresp_lower';'inverse';'realtime';'realtime_new_only';'sensivity';'isFromFile';'QFromFile'; 'showMatrices'; 'showDelta'; 'sdo';...
	'dt';'time';'dt_total';'sp_length';'sp_total';'ptp_name';'sdi';...
	'blocks';'GU1type';'GU2type';'F';'G';'rule1_name';'rule2_name';...
	'U';'qo';'po';'dq';'B';'To';'measurements';'H';'Eps';'R';'Y';'Q';'com_num';'delay']);
...
//==================================
frame_tdt= uicontrol(f, "Position"  , [10 dialog_height - 34*control_height control_width-5 control_height*3],...
"Style"     , "frame",...
"BackgroundColor",[0.9 0.9 0.9]);
...
"Enable", "on",...
"BackgroundColor",[1 1 1]);
text_DELAY = uicontrol(f, "Position"  , [15 dialog_height - 33.5*control_height (control_width-15)/2 control_height],...
"Style"     , "text",...
"String"    , "Интервал : ",...
"horizontalalignment","right",...    
"fontsize"  , 10,...
"BackgroundColor",[0.9 0.9 0.9]);
edit_DELAY = uicontrol(f, "Position"  , [15+(control_width-15)/2 dialog_height - 33.5*control_height (control_width-15)/2 control_height],...
"Style"     , "edit",...
"String"    , string(general.delay),...
"Enable", "on",...
"BackgroundColor",[1 1 1]);
...
// ========================
frame_problems_to_solve= uicontrol(f, "Position"  , [20 + control_width dialog_height - 36*control_height control_width-5 control_height*12],...
"Style"     , "frame",...
"BackgroundColor",[0.9 0.9 0.9]);		 
...
"background"          , [0.9 0.9 0.9], ...
"tag"                , "sdo_checkbox");
sdi_checkbox = uicontrol(f, "Position"  , [25 + control_width dialog_height - 28.5*control_height control_width-15 control_height],......
"style"              , "checkbox",...
"string"             , "СДИ",...
"fontsize"           , 10,...
"value"              , general.sdi, ...
"background"          , [0.9 0.9 0.9], ...
"tag"                , "sdi_checkbox");
inverse_checkbox = uicontrol(f, "Position"  , [25 + control_width dialog_height - 29.5*control_height control_width-15 control_height],......
"style"              , "checkbox",...
...
"tag"                , "inverse_checkbox");
// added by Eugene
dynresp_checkbox = uicontrol(f, "Position"  , [25 + control_width dialog_height - 30.5*control_height control_width-15 control_height],......
"style"              , "checkbox",...
...
dynresp_add_checkbox = uicontrol(f, "Position"  , [35 + control_width dialog_height - 31.5*control_height control_width-25 control_height],......
"style"              , "checkbox",...
...
dynresp_lower_checkbox = uicontrol(f, "Position"  , [35 + control_width dialog_height - 32.5*control_height control_width-25 control_height],......
"style"              , "checkbox",...
...
realtime_checkbox = uicontrol(f, "Position"  , [25 + control_width dialog_height - 33.5*control_height control_width-25 control_height],......
"style"              , "checkbox",...
...
realtime_redraw_checkbox = uicontrol(f, "Position"  , [35 + control_width dialog_height - 34.5*control_height control_width-25 control_height],......
"style"              , "checkbox",...
"string"             , "только новые значения",...
"fontsize"           , 10,...
"value"              , general.dynresp_lower, ...
"background"          , [0.9 0.9 0.9], ...
"tag"                , "realtime_redraw_checkbox");
// end of Eugenes block		
b_solve = uicontrol(f, "Position"  , [25 + control_width+(control_width-15)/2 dialog_height - 35.5*control_height (control_width-15)/2 control_height],...
"Style"     , "pushbutton",...
"String"    , "Решить",...

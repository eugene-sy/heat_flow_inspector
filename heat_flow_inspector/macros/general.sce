...
global general; 
general = tlist(['problem';'direct';'dynresp';'dynresp_additional';'inverse';'realtime';'sensivity';'isFromFile';'QFromFile'; 'showMatrices'; 'showDelta'; 'sdo';...
...
// ========================
frame_problems_to_solve= uicontrol(f, "Position"  , [20 + control_width dialog_height - 33*control_height control_width-5 control_height*9],...
"Style"     , "frame",...
"BackgroundColor",[0.9 0.9 0.9]);		 
...
dynresp_add_checkbox = uicontrol(f, "Position"  , [25 + control_width dialog_height - 31.5*control_height control_width-25 control_height],......
"style"              , "checkbox",...
...
b_solve = uicontrol(f, "Position"  , [25 + control_width+(control_width-15)/2 dialog_height - 32.5*control_height (control_width-15)/2 control_height],...
"Style"     , "pushbutton",...
"String"    , "Решить",...
